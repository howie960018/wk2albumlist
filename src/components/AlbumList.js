    ...
    <ScrollView>
      <View style={styles.cardContainerStyle}>
        <View style={[styles.thumbnailContainerStyle, styles.cardSectionStyle]}>
          ...
          <View style={styles.headerContentStyle}>
            <Text style={styles.songnameStyle}>{albumData[0].title}</Text>
      ...
      <View style={styles.cardContainerStyle}>
        <View style={[styles.thumbnailContainerStyle, styles.cardSectionStyle]}>
          ...
          />
          <View style={styles.headerContentStyle}>
            <Text style={styles.songnameStyle}>{albumData[1].title}</Text>
      ...
      <View style={styles.cardContainerStyle}>
        <View style={[styles.thumbnailContainerStyle, styles.cardSectionStyle]}>
          ...
          />
          <View style={styles.headerContentStyle}>
            <Text style={styles.songnameStyle}>{albumData[2].title}</Text>
      ...
      <View style={styles.cardContainerStyle}>
        <View style={[styles.thumbnailContainerStyle, styles.cardSectionStyle]}>
          ...
          />
          <View style={styles.headerContentStyle}>
            <Text style={styles.songnameStyle}>{albumData[3].title}</Text>
      ...
      <View style={styles.cardContainerStyle}>
        <View style={[styles.thumbnailContainerStyle, styles.cardSectionStyle]}>
          ...
          />
          <View style={styles.headerContentStyle}>
            <Text  style={styles.songnameStyle}>{albumData[4].title}</Text>
